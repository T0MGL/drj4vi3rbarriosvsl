...
export const ConsultationView: React.FC<ConsultationViewProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-brand-dark text-brand-light relative selection:bg-brand-accent selection:text-white lg:h-screen lg:overflow-hidden flex flex-col lg:flex-row font-sans">
      ...
      <div className="w-full lg:w-[45%] relative lg:h-full flex flex-col bg-brand-dark/40 border-b lg:border-b-0 lg:border-r border-white/5 backdrop-blur-sm z-10">
            ...
            <div className="max-w-md mx-auto w-full animate-fade-in-up">
              ...
              <div className="text-center lg:text-left mb-10">
                ...
                <h1 className="font-serif text-4xl lg:text-5xl text-white mb-4 leading-none">
                  ...
                  <span className="italic text-brand-neutral">Comienza Aquí</span>
                </h1>
              ...
              <div className="hidden lg:block space-y-6 mb-12 pl-4 border-l border-white/10">
                 <div className="flex gap-4 items-start opacity-50">
                    <span className="text-brand-accent font-serif text-xl">01</span>
                    <div>
                        <h4 className="text-white text-sm uppercase tracking-wider">Pre-Agendamiento</h4>
                        <p className="text-brand-neutral text-xs">Completa tus datos básicos y preferencias.</p>
                    </div>
                 </div>
                 <div className="flex gap-4 items-start">
                    <span className="text-brand-accent font-serif text-xl">02</span>
                    <div>
                        <h4 className="text-white text-sm uppercase tracking-wider">Evaluación</h4>
                        <p className="text-brand-neutral text-xs">Nuestro equipo analizará tu caso.</p>
                    </div>
                 </div>
                 <div className="flex gap-4 items-start opacity-50">
                    <span className="text-brand-accent font-serif text-xl">03</span>
                    <div>
                        <h4 className="text-white text-sm uppercase tracking-wider">Contacto</h4>
                        <p className="text-brand-neutral text-xs">Te contactaremos para coordinar tu cita.</p>
                    </div>
                 </div>
              </div>
              ...
              <div className="flex justify-center lg:justify-start gap-6 pt-6 border-t border-white/5">
                <a href="https://wa.me/595981003460" className="text-brand-neutral hover:text-brand-accent transition-colors p-2 hover:bg-white/5 rounded-full"><MessageCircle size={20}/></a>
                <a href="https://www.instagram.com/dr.javierbarrios/" className="text-brand-neutral hover:text-brand-accent transition-colors p-2 hover:bg-white/5 rounded-full"><Instagram size={20}/></a>
                <a href="https://www.facebook.com/share/1DUG8wnZFZ/?mibextid=wwXIfr" className="text-brand-neutral hover:text-brand-accent transition-colors p-2 hover:bg-white/5 rounded-full"><Facebook size={20}/></a>
              </div>
            </div>
        </div>
      </div>
